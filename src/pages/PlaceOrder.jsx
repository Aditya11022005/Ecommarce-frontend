        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <form onSubmit={handlePlaceOrder} className="flex-1 bg-white/80 backdrop-blur-md border border-gray-200 rounded-2xl shadow-xl p-6 mb-6 md:mb-0">
            ...
            <div className="mt-2 mb-2">
              <label htmlFor="address" className="text-sm font-medium text-gray-700">Full Address<span className="text-red-500">*</span></label>
              <textarea id="address" name="address" value={form.address} onChange={handleChange} className="border rounded-lg px-3 py-2 mt-1 w-full focus:ring-2 focus:ring-black outline-none bg-white/90" placeholder="Full Address*" rows={2} required />
            </div>
