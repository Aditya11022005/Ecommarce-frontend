        ...
        <div className="fixed z-50 bottom-6 right-6 flex flex-col items-end">
          <AnimatePresence>
            {chatOpen && (
              ...
              >
                <div className="bg-gradient-to-r from-blue-700 to-purple-700 text-white px-4 py-3 flex items-center justify-between">
                ...
                <div className="p-4 min-h-[180px] flex flex-col gap-3">
                  ...
                  {!mode && (
                    <>
                      ...
                      <button onClick={() => setMode('appointment')} className="mb-2 bg-gradient-to-r from-blue-700 to-purple-700 text-white px-4 py-2 rounded-lg hover:from-blue-800 hover:to-purple-800 transition">Book Appointment</button>
                    ...
                    <>
                      {step === 0 && (
                        <>
                          ...
                          />
                          <button
                            className="mt-2 bg-gradient-to-r from-blue-700 to-purple-700 text-white px-4 py-2 rounded-lg hover:from-blue-800 hover:to-purple-800 transition disabled:opacity-50"
                  ...
                  {mode === 'assist' && (
                    <div className="flex flex-col gap-2 h-60 max-h-72">
                      ...
                      <form className="flex gap-2 mt-auto" onSubmit={handleAssistSend} autoComplete="off">
                        <input
                          type="text"
                          value={assistInput}
                        ...
                        <button
                          type="submit"
                          className="bg-gradient-to-r from-blue-700 to-purple-700 text-white px-3 py-2 rounded-lg hover:from-blue-800 hover:to-purple-800 transition disabled:opacity-50"
          ...
          {!chatOpen && (
            <button
              ...
              className="bg-gradient-to-br from-blue-700 to-purple-700 text-white rounded-full shadow-lg p-4 flex items-center justify-center hover:scale-105 transition-all focus:outline-none"
